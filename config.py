...
SMTP_HOST = os.getenv("SMTP_HOST", "smtp.gmail.com") # [IMPROVEMENT]
SMTP_PORT = int(os.getenv("SMTP_PORT", "465"))      # [IMPROVEMENT]
...
# [IMPORTANT] In a production environment, you must set actual keys.
